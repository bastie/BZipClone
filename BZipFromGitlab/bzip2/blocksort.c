...
/*---------------------------------------------*/
static inline void fallbackSimpleSort ( UInt32* fmap, UInt32* eclass, Int32 lo, Int32 hi ) {
  Int32 i;
  Int32 j;
  Int32 tmp;
  UInt32 ec_tmp;
...
static inline UChar mmed3 ( UChar a, UChar b, UChar c ) {
  UChar t;
  if (a > b) { t = a; a = b; b = t; };
  if (b > c) {
    b = c;
